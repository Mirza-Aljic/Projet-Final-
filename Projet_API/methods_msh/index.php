...
<body>
    ...
    <div class="content">
        <h1>Bienvenue sur la table msh, cliquez sur l'option que vous souhaitez</h1>
        <div class="options-container">
            <a href="/website/methods_msh/get_data.php">
                <button>Récupérer les informations</button>
            </a>
            <a href="/website/methods_msh/post_data.php">
                <button>Envoyer des informations</button>
            </a>
            <a href="/website/methods_msh/delete_data_by_id.php">
